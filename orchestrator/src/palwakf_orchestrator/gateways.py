...
checks, commit once, and push only the current governed task branch. Return the
required structured result after every shell call has completed and its output
has been received.
""".strip()
