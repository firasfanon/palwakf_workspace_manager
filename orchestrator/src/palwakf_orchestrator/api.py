...
<head>
  ...
  <title>PalWakf Workspace Manager — جلسة محلية مطلوبة</title>
  <style>
...
<body>
  <main data-palwakf-entrypoint-state="authentication-required">
    <h1>يلزم بدء جلسة محلية آمنة</h1>
    <p>هذه الصفحة محمية ولم تُفتح عبر جلسة المتصفح المحلية المعتمدة.</p>
    <p>شغّل الأمر التالي من مجلد المشروع:</p>
    <p><code>.\\Start-PalWakfWorkspaceManager.ps1</code></p>
    <p>سيفتح المشغّل نافذة المتصفح بجلسة محلية آمنة تلقائيًا. لا تُدخل أي رمز يدويًا.</p>
